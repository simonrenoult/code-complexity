...
// @ts-ignore
var nodeSloc = require("node-sloc");
var path_1 = require("path");
var utils_1 = require("../utils");
var internal = { debug: utils_1.buildDebugger("complexity") };
exports["default"] = {
    compute: function () {
        var args = [];
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(paths.map(function (path) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, getComplexity(path, options)];
                                    case 1:
                                        complexity = _a.sent();
                ...
                case 1:
                    entries = _a.sent();
                    complexityPerPath = entries.reduce(function (map, entry) {
                        map.set(entry.path, entry.complexity);
                        return map;
                    }, new Map());
                    return [2 /*return*/, complexityPerPath];
            }
        });
    });
}
function getComplexity(path, options) {
    return __awaiter(this, void 0, void 0, function () {
        var absolutePath, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    absolutePath = path_1.resolve(options.directory, path);
                    return [4 /*yield*/, nodeSloc({ path: absolutePath })];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result.sloc.sloc || 1];
            }
        });
    });
}
